...
namespace Assessment
{
    static class Program
    {
        ...
        {
            string sql;
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 1, 'Applied Mathematics 3', 3, 'AM 3');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 2, 'Logic Design', 3, 'LD');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 3, 'Data Structures & Analysis', 3, 'DSA');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 4, 'Database Management System', 3, 'DBMS');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 5, 'Principle of Communications', 3, 'PC');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 6, 'Applied Mathematics 4', 4, 'AM 4');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 7, 'Computer Networks', 4, 'CN 2');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 8, 'Operating Systems', 4, 'OS');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 9, 'Computer Organization and Architecture', 4, 'COA');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 10, 'Automata Theory', 4, 'AT');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 11, 'Microcontroller and Embedded Programming', 5, 'MEP');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 12, 'Internet Programming', 5, 'IP');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 13, 'Advanced Data Management Technology', 5, 'ADMT');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 14, 'Cryptography & Network Security ', 5, 'CNS');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 15, 'Department Level Optional Course 1', 5, 'OC 1');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 16, 'Software Engineering with Project Management', 6, 'SEPM');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 17, 'Data Mining and Business Intelligence', 6, 'DMBI');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 18, 'Cloud Computing & Services', 6, 'CCS');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 19, 'Wireless Networks', 6, 'WN');";
            exec(sql);
            sql = "INSERT INTO subjects (dept, id, name, sem, sf) VALUES ('INFT', 20, 'Department Level Optional Course 2', 6, 'OC 2');";
            exec(sql);
        }
